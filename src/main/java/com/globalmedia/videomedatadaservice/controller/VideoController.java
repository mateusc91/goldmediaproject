package com.globalmedia.videomedatadaservice.controller;

import com.globalmedia.videomedatadaservice.service.ExternalVideoMockService;
...
import com.globalmedia.videomedatadaservice.domain.dto.video.VideoStatisticsDto;
...
public class VideoController {
    ...
    public ResponseEntity<List<VideoDto>> importVideos(
        ...
        List<VideoCreateRequest> videosToImport = externalVideoMockService.fetchVideos(source, count);
